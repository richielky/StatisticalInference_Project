...
### Conclusion
The green line is the distribution of averages of the simulated samples. The red line is the normal distribution with lambda = 0.2. The figure shows that the 2 distribution lines, green and red, are well aligned thus the distribution of simulated data is approximately normal.
...
ggplot(sim_mean_df, aes(x=sim_exp)) +
       ...
       stat_function(fun=dnorm, arg=list(mean=tm, sd=0.791), color = "red", size=1) + 
